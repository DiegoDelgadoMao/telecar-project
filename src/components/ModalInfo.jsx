...
export const ModalInfo = ({ product, dispatch }) => {
    ...
    return (
        <div className='w-full h-screen fixed grid place-items-center bg-[#00000024] z-[3] top-0 left-0 '>
            <div className='relative w-4/5 m-w-xl h-4/5 max-h-96 bg-fourth rounded-lg grid grid-cols-1 grid-rows-[1fr_15%]'>
                <div className='overflow-y-scroll w-full h-full '>
                    ...
                    <div className='h-40 w-full grid place-items-center mt-6'>
                        <img src={product.img} alt="" className='w-36 h-36 object-cover' />
                    </div>
                ...
                <div className='grid place-items-center'>
                    <button className='w-11/12 m-w-sm bg-second text-fifth flex justify-evenly items-center h-[78%] rounded-lg'>
                        Cotizar
                        <RiMessage2Fill />
                    </button>
                </div>
